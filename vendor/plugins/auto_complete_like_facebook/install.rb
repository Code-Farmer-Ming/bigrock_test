...
FileUtils.cp_r(File.join(File.dirname(__FILE__),"files/js/prototype_ui_auto_complete_like_facebook/prototype-ui.js"),File.join(File.dirname(__FILE__),"..","..","..","public","javascripts"))
